...
namespace GradesPrototype.Data
{
    ...
    public class Student : IComparable<Student>
    {
        ...
        public void AddGrade(Grade grade)
        {
            ...
            {
                throw new ArgumentException("This grade is already assigned to a student");
            }
        }
    }
    ...
    public class Teacher
    {
        ...
        {
            if (student.TeacherID == 0) { student.TeacherID = this.TeacherID; }
            else { throw new ArgumentException("This student is already assigned to a class"); }
        ...
        public void RemoveFromClass(Student student)
        {
            ...
            {
                throw new ArgumentException("Student", "This student does not belong to your class");
            }
        }
